      ...
      <form v-else class="flex h-[calc(92vh-5.5rem)] min-h-0 flex-col" @submit.prevent="save">
        <div class="shrink-0 border-b border-border bg-surface px-5 py-3 sm:px-6">
          <div class="flex flex-wrap items-center gap-2">
            <input v-model="editor.title" class="min-h-10 min-w-52 flex-1 rounded-md border border-border bg-canvas px-3 py-2" :aria-invalid="Boolean(fieldErrors.title)" aria-label="Título da nota" maxlength="160" placeholder="Título da nota">
